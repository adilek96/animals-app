      ...
      <div className=" shadow-xl shadow-orange-900 h-[100%] w-[250px]  bg-white dark:bg-gray-700  rounded-md  overflow-hidden">
        ...
        <ul>
          ...
          <li>
            <Link
              href=""
              onTouchStart={showPostsSubMenu}
              onTouchMove={hidePostsSubMenu}
            ...
            >
              ...
              {!postsSubActive ? (
                ...
                <FaChevronUp className="text-2xl ml-1 text-gray-400 pt-2 font-extrabold" />
              )}
            </Link>
            {postsSubActive ? (
              <ul
                ...
                className="sticky shadow-md shadow-orange-900 h-[40px] w-[250px] bg-white dark:bg-gray-600   rounded-b-md z-10  "
              >
                <li>
                  <Link
                    href="/posts"
                    onClick={() => setBurgerActive(!burger)}
                    className={`h-[40px] px-7 flex items-center    hover:text-primary-500 `}
                  >
                    {t("allAds")}
                  </Link>
                </li>
          ...
          <Link
            href=""
            onTouchStart={showArticleSubMenu}
            onTouchMove={hideArticleSubMenu}
            onMouseEnter={showArticleSubMenu}
            onMouseLeave={hideArticleSubMenu}
            className={`box-content relative  px-3 flex items-center  hover:text-primary-500 duration-500 ${
              pathname === "/articles"
          ...
          {articleSubActive ? (
            <ul
              onMouseEnter={onMouseInArticleSub}
              onMouseLeave={onMouseOutArticleSub}
              className="sticky shadow-xl shadow-orange-900 h-[200px] w-[250px] bg-white rounded-b-md z-10 "
            >
              <li>
                <Link
                  href="/"
