...
export function TheFooter() {
  ...
  return (
    <footer className={`bg-white dark:bg-inherit dark:inset-0 dark:text-white  overflow-hidden shadow-md-revers shadow-primary-900 box-content  h-fit  text-gray-800  items-center md:flex md:justify-between sm:justify-center content-center md:flex-row sm:flex-col px-12 border-t-[5px] border-primary-500 border-solid  ${footerHide ? 'sm:flex ': 'sm:hidden'}`}>
