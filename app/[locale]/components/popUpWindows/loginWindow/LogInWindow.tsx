    ...
    >
      <div className=" fixed dark:bg-gray-700 md:w-[50vw] md:h-[90vh] sm:h-[90vh]  md:left-[25%] top-[5%] sm:w-[90vw] sm:left-[5%] bg-white z-50 shadow-2xl  shadow-gray-800 rounded-md border-t-[5px] border-primary-500  flex flex-col gap-3 justify-center items-center">
        ...
        {toggle === "forgot" ? (
          <>
            <button
              className={`w-[300px] box-content h-[80px]  flex items-center  hover:text-primary-500 duration-300 ${
                toggle === "forgot"
              ...
              <ul className=" w-[300px] box-content text-[16px] font-bold antialiased flex flex-none h-[80px] items-center ">
                <li>
                  <button
                    ...
                    className={`w-[150px] box-content h-[80px]  flex items-center  hover:text-primary-500 duration-300 ${
                      toggle === "login"
                        ? " text-primary-500 border-t-[5px] border-t-primary-500 border-solid"
                        : ""
                    }`}
