...
export  function TheBottomMenu() {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-inherit  dark:text-white  overflow-hidden shadow-md-revers shadow-primary-900 box-content  h-[50px]  text-gray-800 text-[30px]  items-center sm:flex md:hidden  sm:justify-between content-center   px-12 border-t-[5px] border-primary-500 border-solid ">
