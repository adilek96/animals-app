  ...
  return (
        ...
        />
          ...
          <ul>
            ...
            <li>
                <Link href="/posts"  onTouchEnd={() => setBurgerActive(!burger)}  onTouchMove={showPostsSubMenu} onMouseEnter={showPostsSubMenu} onTouchCancel={hidePostsSubMenu} onMouseLeave={hidePostsSubMenu} className={` box-content relative   px-3 flex items-center  hover:text-primary-500 duration-500 ${pathname === '/posts' ? ' text-primary-500  bg-primary-100  h-[70px]' : 'h-[50px]'}`} >Обьявления <FaChevronDown  className="text-2xl ml-1 text-gray-400 pt-2 font-extrabold"/> </Link>
                {postsSubActive ? 
